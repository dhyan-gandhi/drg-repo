...
model += 73*X11 +  103*X12 + 88*X13 + 108*X14 + 85*X21 + 80*X22 + 100*X23 + 90*X24 \
          + 88*X31 +97*X32 + 78*X33 + 118*X34 + 84*X41 + 79*X42+90*X43+99*X44, "transportation cost minimization"
...
print( f"from Birmingham to Detroit = {X41.varValue}") 
print( f"from Birmingham to Dallas = {X42.varValue}") 
print( f"from Birmingham to New York = {X43.varValue}")
print( f"from Birmingham to Los Angeles = {X44.varValue}") 
